    ...
    <rasterrenderer opacity="1" classificationMin="0" band="1" nodataColor="" classificationMax="5" type="singlebandpseudocolor" alphaBand="-1">
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" colorRampType="INTERPOLATED" labelPrecision="0" classificationMode="2" maximumValue="5">
          ...
          <item alpha="204" label=" Forest - Forest" value="1" color="#73bb53"/>
          <item alpha="255" label="Forest - Built Up" value="2" color="#ff0000"/>
          <item alpha="255" label="Forest - Farm" value="3" color="#eee05d"/>
          <item alpha="255" label="Forest - Barren" value="4" color="#a9a9a9"/>
          <item alpha="255" label="Forest - Scrub land" value="5" color="#eaa4f0"/>
